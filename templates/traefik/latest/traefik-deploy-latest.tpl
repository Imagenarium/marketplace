...
<@swarm.SERVICE 'traefik-${namespace}' 'traefik:alpine' "--logLevel=INFO --metrics.prometheus --web.metrics.prometheus --docker --docker.swarmMode --docker.watch --api --constraints='tag==${namespace}'">
  <@node.MANAGER />
  <@service.SCALABLE />
