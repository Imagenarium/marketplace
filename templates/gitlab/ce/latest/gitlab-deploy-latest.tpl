...
<@requirement.CONFORMS>
  ...
  <@swarm.SERVICE 'gitlab-${namespace}' 'imagenarium/gitlab-ce:rc'>
    ...
    <@service.ENV 'GITLAB_OMNIBUS_CONFIG' "external_url 'https://${PARAMS.HOSTNAME}:${PARAMS.HTTPS_PUBLISHED_PORT}/'; nginx['redirect_http_to_https']=false; registry_external_url 'https://${PARAMS.HOSTNAME}:${PARAMS.REGISTRY_PUBLISHED_PORT}/'" />
  </@swarm.SERVICE>
