...
<@requirement.CONFORMS>
  ...
  <@swarm.SERVICE 'gitlab-${namespace}' 'imagenarium/gitlab-ce:rc'>
    ...
    <@service.ENV 'GITLAB_OMNIBUS_CONFIG' "external_url 'https://${PARAMS.HOSTNAME}:${PARAMS.HTTP_PUBLISHED_PORT}/'; registry_external_url 'https://${PARAMS.HOSTNAME}:${PARAMS.REGISTRY_PUBLISHED_PORT}/'" />
  </@swarm.SERVICE>

  <@docker.HTTP_CHECKER 'gitlab-checker-${namespace}' 'https://${PARAMS.HOSTNAME}:${PARAMS.HTTP_PUBLISHED_PORT}/explore' 'gitlab-net-${namespace}' />
</@requirement.CONFORMS>